...
Состояние: локальный Compose и первый сквозной smoke готовы. Preview-окружения, полная наблюдаемость и
проверки отказов остаются следующими инженерными пакетами.
...
Состояние: backend-срез, общий текстовый вход и renderer-neutral Widget SDK готовы. Conversation
Service, адаптер и реальный календарь ещё не реализованы.
