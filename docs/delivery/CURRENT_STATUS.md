...
| `conversation-service` | Состояние диалога и прикладная оркестрация | Повтор сообщения не создаёт второе действие | Репа и защищённый Java/jOOQ-каркас созданы; contracts `2.3.0`, tests и чистый container scan работают | Решить privacy/retention, затем хранить идемпотентное сообщение |
...
[готово] contracts 2.2.0
    ...
    -> [следом] решение о privacy/retention сообщения
    -> идемпотентное хранение и вызов Agent Runtime
