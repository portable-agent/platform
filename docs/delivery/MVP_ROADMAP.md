...
Это пока гипотеза для планирования, а не утверждённое правило продукта. До реализации нужно принять RFC:

- какой календарь подключаем первым;
- какие поля события обязательны;
- когда требуется подтверждение;
- какую AI-модель и speech-to-text используем;
- какие данные разрешено хранить.
