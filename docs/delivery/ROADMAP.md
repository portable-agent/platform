...
Подробные сроки и критерии выхода описаны в [плане MVP](MVP_ROADMAP.md). Инженерные окружения,
нагрузка и отказоустойчивость описаны в [плане полигона](TEST_PLATFORM.md).

## Фаза 0 — Основа платформы

Состояние: базовая часть готова. Репозитории, общие проверки, локальный Compose, Helm и тестовый полигон
созданы. Наблюдаемость, preview-окружения и проверки отказов остаются в работе.
